...
import Productivia from '../assets/productivia-screenshot.png'
...
export default function ProjectsPage() {
  return (
    <div id='projects' className='h-full md:h-[184rem] lg:h-[115rem] flex flex-col gap-16 lg:gap-12 items-center md:items-start justify-center font-light_display dark:font-dark_display mx-8 md:mx-16 lg:mx-48 py-24 mt-80 md:mt-48 lg:mt-32'>
      ...
      <div className='flex flex-col gap-16 lg:gap-32'>
        ...
        <div id='project-2' className='flex flex-col-reverse lg:flex-row justify-center items-center gap-4 lg:gap-0 bg-tertiary/60 dark:bg-dark_tertiary lg:bg-inherit lg:dark:bg-inherit p-4 lg:p-0 w-[22rem] md:w-full rounded'>
          <div className='lg:w-96 flex lg:flex-1 flex-col justify-center items-start text-left gap-4'>
            ...
            <div className='flex flex-row justify-center gap-4'>
              ...
              <svg className='fill-secondary dark:fill-dark_secondary w-6 hover:fill-title dark:hover:fill-dark_title hover:cursor-not-allowed transition linear duration-500' xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M180-120q-24 0-42-18t-18-42v-600q0-24 18-42t42-18h279v60H180v600h600v-279h60v279q0 24-18 42t-42 18H180Zm202-219-42-43 398-398H519v-60h321v321h-60v-218L382-339Z"/></svg>
            </div>
          </div>
        ...
        <div id='project-3' className='flex flex-col lg:flex-row justify-center items-center w-[22rem] md:w-full bg-tertiary/60 dark:bg-dark_tertiary/60 lg:bg-inherit dark:lg:bg-inherit p-4 lg:p-0 gap-4 lg:gap-0 rounded'>
          ...
          <div className='flex lg:flex-1 flex-col justify-center items-start lg:items-end text-right gap-4 md:w-full lg:w-96'>
            ...
            <div className='relative lg:w-[27rem] md:p-4 md:bg-light lg:bg-tertiary lg:dark:bg-dark_tertiary md:dark:bg-dark rounded'>
              <p className='text-left lg:text-right text-primary dark:text-dark_primary'>An ecommerce admin dashboard that allows a store owner to take full control of there site with this CMS. Adding products, billboards, even categories are all available to change.</p>
            </div>
            <ul className='flex flex-row gap-4 font-light_mono dark:font-dark_mono text-secondary dark:text-dark_secondary font-bold'>
              <li>Next.js</li>
              <li>Tailwind</li>
        ...
        <div id='project-4' className='flex flex-col-reverse lg:flex-row justify-center items-center bg-tertiary/60 dark:bg-dark_tertiary/60 lg:bg-inherit lg:dark:bg-inherit p-4 lg:p-0 w-[22rem] md:w-full gap-4 lg:gap-0 rounded'>
          <div className='lg:w-96 flex lg:flex-1 flex-col justify-center items-start text-left gap-4'>
            ...
            <div className='relative z-10 lg:w-[27rem] md:p-4 md:bg-light lg:bg-tertiary lg:dark:bg-dark_tertiary md:dark:bg-dark rounded'>
              <p className='text-left text-primary dark:text-dark_primary'>A demo ecommerce store with all the bells and whistles, including a fully functional cart using the Stripe CLI.</p>
            </div>
            <ul className='flex flex-row gap-4 font-light_mono dark:font-dark_mono text-secondary dark:text-dark_secondary font-bold'>
              <li>Next.js</li>
              <li>Tailwind</li>
        ...
        <div id='project-5' className='flex flex-col lg:flex-row justify-center items-center w-[22rem] md:w-full bg-tertiary/60 dark:bg-dark_tertiary/60 lg:bg-inherit dark:lg:bg-inherit p-4 lg:p-0 gap-4 lg:gap-0 rounded'>
          ...
          <div className='flex lg:flex-1 flex-col justify-center items-start lg:items-end text-right gap-4 md:w-full lg:w-96'>
            ...
            <div className='relative lg:w-[27rem] md:p-4 md:bg-light lg:bg-tertiary lg:dark:bg-dark_tertiary md:dark:bg-dark rounded'>
              <p className='text-left lg:text-right text-primary dark:text-dark_primary'>A multi-page dynamic website redesign for Your Ticket To College, LLC. A reputable tutoring service for high school students looking to take the SAT and ACT exams.</p>
            </div>
            <ul className='flex flex-row gap-4 font-light_mono dark:font-dark_mono text-secondary dark:text-dark_secondary font-bold'>
              <li>Wix</li>
            </ul>
