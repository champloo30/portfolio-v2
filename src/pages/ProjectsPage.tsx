...
export default function ProjectsPage() {
  return (
    <div id='projects' className='h-[155rem] md:h-[184rem] lg:h-[115rem] flex flex-col gap-16 lg:gap-12 items-start justify-center font-light_display dark:font-dark_display mx-8 md:mx-16 lg:mx-48 py-24'>
      ...
      <div className='flex flex-col gap-16 lg:gap-32'>
        ...
        <div id='project-3' className='flex flex-col lg:flex-row justify-center items-center w-[22rem] md:w-full bg-tertiary/60 dark:bg-dark_tertiary/60 lg:bg-inherit dark:lg:bg-inherit p-4 lg:p-0 gap-4 lg:gap-0 rounded'>
          ...
          <div className='flex lg:flex-1 flex-col justify-center items-start lg:items-end text-right gap-4 md:w-full lg:w-96 mt-64 md:mt-0'>
