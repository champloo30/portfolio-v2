...
export default function ProjectsPage() {
  return (
    <div id='projects' className='h-[155rem] md:h-[184rem] lg:h-[115rem] flex flex-col gap-16 lg:gap-12 items-start justify-center font-light_display dark:font-dark_display mx-8 md:mx-16 lg:mx-48 py-24 mt-64 md:mt-0'>
