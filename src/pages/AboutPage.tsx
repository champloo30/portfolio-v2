...
export default function AboutPage() {
  return (
    <div id='about' className='h-300 sm:h-dvh w-screen flex justify-center items-center font-light_display dark:font-dark_display'>
      <Container>
        <div className='h-full w-full flex flex-col lg:flex-row justify-center items-center md:gap-4 lg:gap-0'>
          <div className='flex flex-col justify-center items-start gap-2'>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-light_mono dark:font-dark_mono text-title dark:text-dark_title">About Me</h1>
            <p className=' md:w-full lg:w-2/3 text-primary dark:text-dark_primary'>
            ...
            <div className='flex flex-row flex-wrap gap-0.5 md:gap-6 lg:gap-4'>
              <ul>
          ...
          <div className='flex relative top-8 lg:top-0 group'>
            <div className="w-[360px] h-[480px] border-2 border-title dark:border-dark_title rounded-sm relative left-3 group-hover:translate-x-2 group-hover:translate-y-2 transition linear duration-300"></div>
            <Image 
              className='bg-title rounded-sm absolute -top-3 group-hover:-translate-x-2 group-hover:-translate-y-2 transition linear duration-300'
              src={DJLD}
              width={360}
              height={420}
              alt='Dalyn Dunn'
            />
            <div className="w-[360px] h-[480px] bg-title dark:bg-dark_title rounded-sm absolute -top-3 opacity-60 hover:opacity-0 transition linear duration-300"></div>
          </div>
        </div>
      </Container>
    </div>
