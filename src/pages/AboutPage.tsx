...
export default function AboutPage() {
  return (
    <div id='about' className='flex flex-row items-center h-screen font-light_display dark:font-dark_display mx-48'>
      <div className='flex flex-1 flex-col justify-center items-start gap-2'>
        <h1 className="text-5xl font-light_mono dark:font-dark_mono text-title dark:text-dark_title">About Me</h1>
        <p className='w-5/6 text-primary dark:text-dark_primary'>
