...
export default function AboutPage() {
  return (
    <div id='about' className='h-[70rem] flex flex-col lg:flex-row justify-center items-center h-screen font-light_display dark:font-dark_display mx-8 lg:mx-48'>
      <div className='flex lg:flex-1 flex-col justify-center items-start gap-2'>
        <h1 className="text-3xl lg:text-5xl font-light_mono dark:font-dark_mono text-title dark:text-dark_title mt-32">About Me</h1>
        <p className='w-80 lg:w-5/6 text-primary dark:text-dark_primary'>
        ...
        <div className='flex flex-row gap-0.5 lg:gap-4'>
          <ul>
      ...
      <div className='flex relative top-8 group'>
