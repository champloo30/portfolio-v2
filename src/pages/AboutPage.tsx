...
export default function AboutPage() {
  return (
    <div id='about' className='h-[75rem] md:h-screen flex flex-col lg:flex-row justify-center items-center h-screen font-light_display dark:font-dark_display mx-8 md:mx-16 lg:mx-48 md:gap-4 lg:gap-0 mt-44 md:mt-0'>
