...
export default function BottomNav() {
  ...
  return (
    <div className='relative z-10 opacity-60'>
      <div className='fixed bottom-8 inset-x-0 flex flex-row justify-center items-center gap-4'>
        <motion.div className='relative group w-12 h-12 rounded-full border-2 border-title dark:border-dark_title cursor-pointer hover:bg-title dark:hover:bg-dark_title transition linear duration-300' variants={ScrollToTopVariants} initial="hide" animate={controls} onClick={() => setIsOpen(!isOpen)}>
          <span className='absolute font-light_display dark:font-dark_display text-title dark:text-dark_title opacity-0 group-hover:opacity-100 -top-8 transition linear duration-300'>Menu</span>
        ...
        {isOpen === true ? 
          <ul className='flex flex-row gap-4'>
            <Link href='/#about'>
              <li className='relative group w-12 h-12 rounded-full border-2 border-title dark:border-dark_title cursor-pointer hover:bg-title dark:hover:bg-dark_title transition linear duration-300'>
