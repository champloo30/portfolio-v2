...
export default function Navbar() {
  ...
  return (
    <div className="fixed lg:relative flex flex-row justify-between h-20 font-light_display dark:font-dark_display lg:mx-auto w-screen bg-light/90 dark:bg-dark/90 z-30">
      ...
      <div className="hidden md:flex flex-1 w-1/2 justify-end items-center text-primary dark:text-dark_primary">
      ...
      <div className='h-20 md:hidden mr-12 flex justify-end items-center'>
        <div className='flex flex-col justify-center items-center gap-8'>
          ...
          <ul className={isOpen === false ? `hidden` : `absolute top-0 left-0 w-screen h-screen flex flex-col justify-center items-center gap-4 bg-light/90 dark:bg-dark/90 text-2xl text-primary dark:text-dark_primary`}>
            ...
            <ul className='flex flex-row gap-4 mt-8'>
              ...
              <li>
                <a href="https://github.com/champloo30" target="_blank" rel="noopener noreferrer">
                  <svg className='fill-secondary dark:fill-dark_secondary w-6' viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <a href="mailto:djld30@gmail.com">
                  <svg className='w-7 fill-secondary dark:fill-dark_secondary' xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
            ...
            <p className='absolute bottom-8 text-title dark:text-dark_title text-base'>Designed & Developed by DJLDev</p>
          </ul>
        </div>
