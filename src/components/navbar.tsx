...
export default function Navbar() {
  ...
  return (
    <div className="fixed lg:relative flex flex-row justify-between h-20 font-light_display dark:font-dark_display lg:mx-auto w-screen lg:w-auto bg-light/90 dark:bg-dark/90 z-30">
      <div className="flex justify-start items-center ml-8 md:ml-16 lg:ml-0">
        <a href="/">
          <Image
      ...
      <div className="hidden lg:flex flex-1 w-1/2 justify-end items-center text-primary dark:text-dark_primary">
